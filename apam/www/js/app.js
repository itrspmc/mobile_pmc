...
const nama_instansi = "RS Pamanukan Medical Center (PMC)"; // Hospital Name
const apiUrl = "http://172.16.0.5/rme/api/"; // API Server URL
const website_upload = "http://172.16.0.5/rme/uploads/"; // Website Uploads Server URL
const webapps_url = "http://172.16.0.252/webapps2/"; // Webapps Server URL
...
const endDate = 3; // End date of day for registration
...
if (debug == "1") {
    ...
    function appReady() {
        ...
        function onBackKeyDown() {
            ...
            if (page === "landing") {
                app.dialog.confirm(
                    "Anda yakin ingin menutup aplikasi APAM?",
                    function() {
                    ...
                    app.notification
                        .create({
                            ...
                            text: "Pendaftaran tanggal " +
                                ...
                                " berstatus <b>" +
                                stts +
                                "</b>. Silahkan lihat data booking untuk detail dan tangkapan layar bukti daftar.",
                            closeButton: true,
                            closeOnClick: true,
                            on: {
                                close: function() {},
                ...
                if (data.state == "notifberkas") {
                    ...
                    app.notification
                        .create({
                            ...
                            text: "<b>" +
                                stts +
                                "</b>. Silahkan menuju ke Klinik pilihan anda di " +
                                nama_instansi +
                                " untuk mendapatkan layanan prioritas tanpa harus antri di loket pendaftaran.",
                            closeButton: true,
                            closeOnClick: true,
                            on: {
                                close: function() {},
            ...
            app.request.post(
                ...
                function(data) {
                    ...
                    if (data.state == "retensi") {
                        app.dialog.alert(
                            "Data anda telah masuk ke fase Retensi dan tidak aktif. SIlahkan hubungi petugas Rumah Sakit."
                        );
                    } else if (data.state == "invalid") {
                        app.dialog.alert(
                            "Nomor kartu dan/atau nomor KTP anda tidak sesuai."
                        );
            ...
            app.request.post(
                ...
                function(data) {
                    ...
                    if (data.state == "invalid") {
                        app.dialog.alert(
                            "Gagal menyimpan data pendaftaran. Silahkan ulangi lagi beberapa saat."
                        );
...
$$(document).on("page:init", '.page[data-name="postregister"]', function(e) {
    ...
    app.dialog.alert(
        "Kode validasi telah dikirim alamat email anda. Silahkan cek."
    );
    ...
    app.request.post(
        ...
        function(data) {
            ...
            $$('.page[data-name="postregister"] .saveregister-btn').on(
                "click",
                function() {
                    ...
                    if (kode_validasi == localStorage.getItem("kode_validasi")) {
                        ...
                        app.request.post(
                            ...
                            function(data) {
                                ...
                                if (data.state == "invalid") {
                                    app.dialog.alert(
                                        "Gagal menimpan data pendaftaran. Silahkan ulangi lagi."
                                    );
                                } else if (data.state == "valid") {
                        ...
                        app.dialog.alert(
                            "Kode validasi salah. Silahkan cek di email anda."
                        );
                    }
                }
            );
...
$$(document).on("page:init", '.page[data-name="home"]', function(e) {
    ...
    app.request.post(
      ...
      html += '</li>';*/
                ...
                html +=
                    '    <div class="dz-media"><a href="/news/' +
                    data[i]["id"] +
                    '/"><img src="' +
                    website_upload +
                    "website/news/" +
                ...
                html +=
                    '        <a href="/course-detail/" class="categorie">Berita</a>';
                html +=
                    '        <h6 class="item-title title"><a href="/news/' +
                    data[i]["id"] +
                    '/">' +
                    data[i]["title"] +
                    "</a></h6>";
                ...
                html +=
                    '              <path d="m28 3h-22a1 1 0 0 0 -1 1v5h-1a1 1 0 0 0 0 2h1v4h-1a1 1 0 0 0 0 2h1v4h-1a1 1 0 0 0 0 2h1v5a1 1 0 0 0 1 1h22a1 1 0 0 0 1-1v-24a1 1 0 0 0 -1-1zm-1 24h-20v-4h1a1 1 0 0 0 0-2h-1v-4h1a1 1 0 0 0 0-2h-1v-4h1a1 1 0 0 0 0-2h-1v-4h20z"/>';
                html +=
                    '              <path d="m19 14h4a1 1 0 0 0 1-1v-4a1 1 0 0 0 -1-1h-4a1 1 0 0 0 -1 1v4a1 1 0 0 0 1 1zm1-4h2v2h-2z"/>';
                html += "            </svg>";
                html += "            " + data[i]["tanggal"] + "";
                html += "          </li>";
                html += "        </ul>";
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html += '  <div class="col">';
                html +=
                    '      <div class="text-align-center" style="font-size:18px;font-weight:bold;text-shadow: 2px 2px 4px #000000;color:#fff;padding-top:5px;">' +
                    data[i]["nm_poli"] +
                    "</div>";
                html += "  </div>";
                html += "</div>";
                ...
                html += '  <div class="col">';
                html +=
                    '      <div class="text-align-center" style="font-size:18px;font-weight:bold;text-shadow: 2px 2px 4px #000000;color:#fff;padding-top:px;">' +
                    data[i]["nm_dokter"] +
                    "</div>";
                html += "  </div>";
                html += "</div>";
                ...
                html +=
                    '      <div class="text-align-center" style="font-size:50px;font-weight:bold;text-shadow: 2px 2px 4px #000000;color:#fff;padding-top:0px;">' +
                    data[i]["no_reg"] +
                    "</div>";
                html += "  </div>";
                html += "</div>";
        ...
        function(data) {
            ...
            if (data.state == "offline") {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html +=
                        '      <div class="facebook-avatar"><img src="img/logo-bpjs.png" width="36" height="36"/></div>';
                    html +=
                        '      <div class="facebook-name">Rujukan BPJS Kesehatan</div>';
                    html +=
                        '      <div class="facebook-date">No. Peserta : ' +
                        data[i]["noKartu"] +
                        "</div>";
                    html += "    </div>";
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html +=
                    '  <div class="item-title"><i class="text-success fa fa-circle"></i> ' +
                    data[i]["judul"] +
                    "</div>";
                ...
                if (data[i]["status"] == "unread") {
                    html +=
                        '    <span class="text-primary tandai_sudah_dibaca color-red" data-judul="' +
                        data[i]["judul"] +
                        '" data-id="' +
                        data[i]["id"] +
                        '">Tandai dibaca</span>';
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html +=
                    ...
                    '/" class="item-link item-content">';
                html +=
                    '    <div class="item-media"><img src="img/' +
                    data[i]["jk"] +
                    '.png" width="50"></div>';
                html += '    <div class="item-inner">';
                html += '      <div class="item-title-row">';
                html +=
                    '        <div class="item-title">' + data[i]["nm_dokter"] + "</div>";
                html += "      </div>";
                ...
                app.request.post(
                    ...
                    function(data) {
                        ...
                        if (data.state == "notfound") {
                            html +=
                                '<li><div class="item-content">Tidak ada jadwal dokter hari ini</div></li>';
                        } else {
                            for (i = 0; i < data.length; i++) {
                                html += "<li>";
                                html +=
                                ...
                                html += '   <div class="item-title">';
                                html +=
                                    '    <div class="item">' + data[i]["nm_poli"] + "</div>";
...
$$(document).on(
    "page:init",
    '.page[data-name="telemedicinedaftar"]',
    function(e) {
        var page = e.detail;
        ...
        $$('.page[data-name="telemedicinedaftar"] .daftar-btn').on(
            "click",
            function() {
                if (no_rkm_medis == "") {
                    app.dialog.alert(
                        "Nomor rekam medis anda tidak sesuai dengan akun login."
                    );
                } else if (tanggal == "") {
                    ...
                    app.request.post(
                        ...
                        function(data) {
                            ...
                            if (data.state == "duplication") {
                                app.dialog.alert(
                                    "Anda sudah terdaftar ditanggal pilihan anda."
                                );
                            } else if (data.state == "limit") {
                                app.dialog.alert(
                                    "Kuota pendaftaran terpenuhi. Silahkan pilih hari/tanggal lain."
                                );
...
$$(document).on(
    "page:init",
    '.page[data-name="telemedicinesukses"]',
    function(e) {
        var no_rkm_medis = localStorage.getItem("no_rkm_medis");
        ...
        app.request.post(
            ...
            function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html +=
                        '    <div class="item-header">Tanggal booking: ' +
                        data[i]["tanggal_booking"] +
                        "</div>";
                    html +=
                        '    <div class="item-header">Tanggal periksa: ' +
                        data[i]["tanggal_periksa"] +
                        "</div>";
                    html +=
                        '    <div class="item">Status booking: ' +
                        data[i]["status"] +
                        "</div>";
                    html += "    Klinik: " + data[i]["nm_poli"] + "";
                    html +=
                        '    <div class="item">Dokter: ' + data[i]["nm_dokter"] + "</div>";
                    html +=
                        '    <div class="item">Nomor antrian: ' +
                        data[i]["no_reg"] +
                        "</div>";
                    html +=
                        '    <div class="item-footer">Cara bayar: ' +
                        data[i]["png_jawab"] +
                        "</div>";
                    html +=
                        '    <div class="item-footer"><br><br><a onclick=\'window.open("' +
                        data[i]["paymentUrl"] +
                        '","_blank", "location=yes")\' href=\'javascript:void(0)\' class="button button-large button-round button-outline">Bayar DISINI</a></div>';
                    html += "   </div>";
                    html += "  </div>";
                    html += " </div>";
                }
...
$$(document).on("page:init", '.page[data-name="bookingdetail"]', function(e) {
    ...
    (cellSize = 6), (margin = 10);
    var qr = qrcode(typeNumber, errorCorrectionLevel);
    qr.addData(no_reg);
    qr.make();
    document.getElementById("qrBooking").innerHTML = qr.createImgTag(
        cellSize,
        margin
    );
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html += "    Nomor Kartu Berobat: " + no_rkm_medis + "";
                html +=
                    '    <div class="item-header">Tanggal daftar: ' +
                    data[i]["tanggal_booking"] +
                    "</div>";
                html +=
                    '    <div class="item-header">Tanggal periksa: ' +
                    ...
                    "</div>";
                html +=
                    '    <div class="item-header">Status validasi: ' +
                    data[i]["status"] +
                    "</div>";
                html += "    Klinik: " + data[i]["nm_poli"] + "";
                html +=
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html +=
                    '    <div style="font-size:12px;">Kapasitas: ' +
                    data[i]["total"] +
                    "</div>";
                html += "   </div>";
                html += "  </div>";
                ...
                app.request.post(
                    ...
                    function(data) {
                        ...
                        if (data.state == "notfound") {
                            ...
                            for (i = 0; i < data.length; i++) {
                                html += '<div class="card card-dokter">';
                                html += "<li>";
                                html += ' <div class="item-content">';
                                html +=
                                    '  <div class="item-media"><img src="img/' +
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html +=
                    '     <div class=""><b>Kode:</b> ' + data[i]["kd_billing"] + "</div>";
                html +=
                    '     <div class=""><b>Total:</b> Rp. ' +
                    data[i]["total_bayar"] +
                    "</div>";
                html += "    </div>";
                html += "   </div>";
...
$$(document).on(
    "page:init",
    '.page[data-name="riwayatranaplist"]',
    function(e) {
        var no_rkm_medis = localStorage.getItem("no_rkm_medis");
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html += '   <div class="item-title">';
                html +=
                    '    <div class="item">Klinik: ' + data[i]["nm_poli"] + "</div>";
                html +=
                    '    <div style="font-size:12px;">Tarif: Rp. ' +
                    data[i]["registrasi"] +
                    "</div>";
                html += "   </div>";
                html += "  </div>";
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html += '   <div class="item-title">';
                html +=
                    '    <div class="item">Jenis: ' + data[i]["nm_perawatan"] + "</div>";
                html +=
                    '    <div style="font-size:12px;">Tarif: ' +
                    data[i]["total_byr"] +
                    "</div>";
                html += "   </div>";
                html += "  </div>";
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html +=
                    '      <div class="item-after">' + data[i]["no_rawat"] + "</div>";
                html += "     </div>";
                html += "    </div>";
                html += "   </li>";
                html += "   <li>";
                ...
                html +=
                    '      <div class="item-after">' + data[i]["nm_poli"] + "</div>";
                html += "     </div>";
                html += "    </div>";
                html += "   </li>";
                html += "   <li>";
                ...
                html +=
                    '      <div class="item-after">' + data[i]["nm_dokter"] + "</div>";
                html += "     </div>";
                html += "    </div>";
                html += "   </li>";
                html += "   <li>";
                ...
                html +=
                    '      <div class="item-after">' + data[i]["png_jawab"] + "</div>";
                html += "     </div>";
                html += "    </div>";
                html += "   </li>";
                html += "  </ul>";
                ...
                html +=
                    '  <div class="card-content">Keluhan: ' +
                    data[i]["keluhan"] +
                    "</div>";
                html +=
                    '  <div class="card-content">Pemeriksaan: ' +
                    data[i]["pemeriksaan"] +
                    "</div>";
                html += "</div>";
                ...
                html += '<div class="card padding">';
                html +=
                    '  <div class="card-content">' + data[i]["nm_penyakit"] + "</div>";
                html += "</div>";

                html += '<div class="block-title">Resep Obat</div>';
                html += '<div class="card padding">';
                html +=
                    '  <div class="card-content">' + data[i]["nama_brng"] + "</div>";
                html += "</div>";
                ...
                if (data[i]["gambar_radiologi"] == null) {
                    html +=
                        '  <div class="card-content">' +
                        data[i]["gambar_radiologi"] +
                        "</div>";
                } else {
                    html +=
                        '  <div class="card-content"><img src="' +
                        webapps_url +
                        "radiologi/" +
                        data[i]["gambar_radiologi"] +
                        '" width="100%"/></div>';
...
$$(document).on(
    "page:init",
    '.page[data-name="riwayatranap-detail"]',
    function(e) {
        var page = e.detail;
        var no_rkm_medis = page.route.params.no_rkm_medis;
        var tgl_registrasi = page.route.params.tgl_registrasi;
        ...
        app.request.post(
            ...
            function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html +=
                        '      <div class="item-after">' + data[i]["nm_bangsal"] + "</div>";
                    html += "     </div>";
                    html += "    </div>";
                    html += "   </li>";
                    html += "   <li>";
...
$$(document).on("page:init", '.page[data-name="profil"]', function(e) {
    ...
    qr.make();
    document.getElementById("qrKartuVirtual").innerHTML = qr.createImgTag(
        cellSize,
        margin
    );
...
$$(document).on("page:init", '.page[data-name="daftar"]', function(e) {
        ...
        if (tanggal == "") {
            ...
            app.request.post(
                ...
                function(data) {
                    ...
                    var html = "";
                    html +=
                        '<option class="kd_poli" value="" selected>____Pilih Klinik____</option>';
                    for (i = 0; i < data.length; i++) {
                        html +=
                            '<option class="kd_poli" value="' +
                            data[i]["kd_poli"] +
                            '">' +
                            data[i]["nm_poli"] +
                            " [" +
                    ...
                    $$(".klinik-list~.item-content .item-after").html(
                        "____Pilih Klinik____"
                    );
                }
            );
                ...
                app.request.post(
                    ...
                    function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html +=
                                '    <input type="radio" class="kd_dokter" name="kd_dokter" value="' +
                                data[i]["kd_dokter"] +
                                '" ' +
                                attrStr +
                                ">";
                        ...
                        $$(".dokter-list").html(html);
                        $$(".dokter-list~.item-content .item-after").html(
                            data[0]["nm_dokter"]
                        );
                        $$(".dokter-list").show();
                    }
    ...
    $$('.page[data-name="daftar"] .daftar-btn').on("click", function() {
        ...
        if (no_rkm_medis == "") {
            ...
            app.dialog.confirm(
                '<center>Anda memilih cara bayar<br>BPJS Kesehatan.<br><img src="img/logo_mjkn.png" width="150px"><br>Apakah anda akan berpindah ke aplikasi<br>Mobile JKN BPJS?</center>',
                function() {
                    window.open(
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                qr.make();
                document.getElementById("qrBookingSukses").innerHTML = qr.createImgTag(
                    cellSize,
                    margin
                );
                html += ' <div class="item-content">';
...
$$(document).on("page:init", '.page[data-name="pengaduan"]', function(e) {
    ...
    app.request.post(
      ...
      html += '</li>';*/
                ...
                html += '      <div class="item-title-row">';
                html +=
                    '        <div class="item-title">' + data[i]["nm_pasien"] + "</div>";
                html +=
                    '        <div class="item-after text-primary"><i class="fa fa-check ml-5"></i></div>';
                html += "      </div>";
                html +=
                    ...
                    "</div>";
                html +=
                    '      <div class="item-subtitle">' + data[i]["tanggal"] + "</div>";
                html += "    </div>";
                html += "  </a>";
                html += "</li>";
            }
            ...
            app.request.post(
                ...
                function(data) {
                    ...
                    if (data.state == "success") {
                        app.dialog.alert(
                            "Pengaduan anda telah disimpan!. Silahkan tekan tombol <b>Ya</b> untuk kembali ke halaman utama.",
                            function() {
...
$$(document).on(
    "page:init",
    '.page[data-name="pengaduandetail"]',
    function(e) {
        var page = e.detail;
        var no_rkm_medis = page.route.params.no_rkm_medis;
        ...
        app.request.post(
            ...
            function(data) {
                ...
                if (data.state == "invalid") {
                    ...
                    html += '  <div class="card-header">';
                    html +=
                        '    <div class="facebook-avatar"><img src="img/L.png" width="34" height="34"/></div>';
                    html += '    <div class="facebook-name">Bagian Pengaduan</div>';
                    html += '    <div class="facebook-date">' + nama_instansi + "</div>";
                    html += "  </div>";
                    html += '  <div class="card-content card-content-padding">';
                    html +=
                        "    <p>Pengaduan dengan nomor #<b>" +
                        pengaduan_id +
                        "</b> masih dalam proses verifikasi. Maaf atas ketidaknyamanan ini.</p>";
                    html += "  </div>";
                    html += "</div>";
                } else {
                    for (i = 0; i < data.length; i++) {
                        ...
                        html +=
                            '    <div class="facebook-avatar"><img src="img/L.png" width="34" height="34"/></div>';
                        html +=
                            '    <div class="facebook-name">' + data[i]["nama"] + "</div>";
                        html +=
                            '    <div class="facebook-date">' + data[i]["tanggal"] + "</div>";
                        html += "  </div>";
                        html += '  <div class="card-content card-content-padding">';
        ...
        $$('.page[data-name="pengaduandetail"] .pengaduandetail-btn').on(
            "click",
            function() {
                var no_rkm_medis = localStorage.getItem("no_rkm_medis");
                ...
                if (message == "") {
                    ...
                    app.request.post(
                        ...
                        function(data) {
                            ...
                            if (data.state == "success") {
                                app.dialog.alert(
                                    "Balasan pengaduan anda telah disimpan!. Silahkan tekan tombol <b>Ya</b> untuk kembali ke halaman pengaduan.",
                                    function() {
                                        app.views.main.router.back("/pengaduan/", {
                                            ignoreCache: true,
                                            force: true,
    ...
    app.request.post(
        ...
        function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                html += ' <div class="card-header">';
                html +=
                    '   <div class="demo-facebook-avatar"><img src="' +
                    website_upload +
                    "website/news/" +
                    data[i]["cover_photo"] +
                    '" width="34" height="34"/></div>';
                html +=
                    '   <div class="demo-facebook-name">' + data[i]["title"] + "</div>";
                html +=
                    '   <div class="demo-facebook-date">' + data[i]["tanggal"] + "</div>";
                html += " </div>";
                html += ' <div class="card-content card-content-padding">';
                html +=
                    '   <img src="' +
...
$$(document).on("page:init", '.page[data-name="pengaturan"]', function(e) {
    ...
    $$('select[name="color"]').on("change", function() {
        ...
        $$(".view").removeClass(
            "color-theme-default color-theme-red color-theme-blue color-theme-lightblue color-theme-green color-theme-pink color-theme-orange color-theme-deeporange color-theme-yellow color-theme-lime color-theme-teal color-theme-purple color-theme-deeppurple color-theme-gray color-theme-black"
        );
        $$(".view").addClass(this.value);
    });
});
...
$$(document).on("page:init", '.page[data-name="akun"]', function(e) {
    ...
    $$(".hapus-akun-btn").on("click", function() {
        ...
        app.dialog.confirm(
            "Anda yakin ingin menghapus akun Rekam Medik anda?",
            function() {
                app.request.post(
                    apiUrl + "apam/", {
                    ...
                    function(data) {
                        ...
                        if (data.state == "success") {
                            app.dialog.alert(
                                "Anda telah menghapus akun Rekam Medik anda sepenuhnya dari sistem!. Silahkan tekan tombol <b>Ya</b> untuk kembali ke halaman utama.",
                                function() {
                                    localStorage.removeItem("no_rkm_medis");
                                    mainView.router.navigate("/", {
                                        clearPreviousHistory: true,
